...
public class MyScreenRecorder extends ScreenRecorder{
	...
	@Override
	//It will create a new folder and it will append a string you are passing and your .AVI file will be generated.
	...
	//This method is used to start the recording based on the code tyou have entered here.
